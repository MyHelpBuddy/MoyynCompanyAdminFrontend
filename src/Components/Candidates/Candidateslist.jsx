...
function Candidateslist({ candidates }) {
  ...
  let nrml = candidates.filter(
    (val) =>
      (val.short === false && val.reject === false && val.select === false) ||
      (val.short === true && val.reject === true && val.select === true)
  );
  let shortlisted = candidates.filter(
    (val) => val.short === true && val.reject === false && val.select === false
  );
  let rejected = candidates.filter(
    (val) => val.short === false && val.select === false && val.reject === true
  );
  let selected = candidates.filter(
    (val) => val.short === false && val.reject === false && val.select === true
  );
        ...
        <div className="flex flex-row-l flex-row-m flex-column">
          <div className="flex">
            ...
            <div className="flex flex-column items-start">
              <p className="ma0 f4-l f5-m f7 pb2 tc">
        ...
        <div className="flex flex-row-l flex-column  mt4 w-100">
          <div className="flex flex-column justify-around items-center w-100">
            ...
            >
              <Button
                onClick={() => {
                  defaultfunc(setmdef, setmcandidate_type);
                }}
                variant="contained"
                className={`cbtn ${
                  mdef && !mcandidate_type && changebtn ? "cbtn-active" : ""
                }`}
              >
                Candidates
              </Button>
              <Button
                onClick={() => {
                  shortlist(setmdef, setmcandidate_type);
                }}
                variant="contained"
                className={`cbtn ${
                  mcandidate_type && !mdef && changebtn ? "cbtn-active" : ""
                }`}
              >
                Shortlisted
              </Button>
              <Button
                onClick={() => {
                  reject(setmdef, setmcandidate_type);
                }}
                variant="contained"
                className={`cbtn ${
                  !mcandidate_type && !mdef && changebtn ? "cbtn-active" : ""
              ...
              <Button
                onClick={() => {
                  selectfun(setmdef, setmcandidate_type);
                }}
                variant="contained"
                className={`cbtn ${
                  mcandidate_type && mdef && changebtn ? "cbtn-active" : ""
              ...
              >
                <span className="hide-mo mr1">Sent to </span> Client
              </Button>
            </div>
          </div>
          <div className="flex flex-column justify-around mt3 mt0-l items-center w-100">
            ...
            >
              <Button
                onClick={() => {
                  defaultfunc(setdef, setcandidate_type);
                }}
                variant="contained"
                className={`cbtn ${
              ...
              <Button
                onClick={() => {
                  shortlist(setdef, setcandidate_type);
                }}
                variant="contained"
                className={`cbtn ${
              ...
              <Button
                onClick={() => {
                  reject(setdef, setcandidate_type);
                }}
                variant="contained"
                className={`cbtn ${
                  !candidate_type && !def && !changebtn ? "cbtn-active" : ""
              ...
              <Button
                onClick={() => {
                  selectfun(setdef, setcandidate_type);
                }}
                variant="contained"
                className={`cbtn ${
                  candidate_type && def && !changebtn ? "cbtn-active" : ""
          ...
          {candidates.length <= 0 || candidates === undefined ? (
            <div className="mt4 flex justify-center items-center">
              <p className="ma0 f3-l f4-m f6 gray tc">
                No, Candidate matched with your job Profile
              </p>
            </div>
            ...
            selected.length <= 0 ? (
              ...
              selected.map((data, id) => <Selected candidate={data} key={id} />)
            )
          ) : mdef && changebtn ? (
            nrml.length <= 0 ? (
              <div className="flex mt4 justify-center items-center">
              ...
              nrml.map((data, id) => <Candidate candidate={data} key={id} />)
            )
            ...
            shortlisted.length <= 0 ? (
              ...
              shortlisted.map((data, id) => (
                <Shortlist candidate={data} key={id} />
              ))
            )
          ) : !mdef && !mcandidate_type && changebtn ? (
            rejected.length <= 0 ? (
              ...
              rejected.map((data, id) => <Rejected candidate={data} key={id} />)
            )
            ...
            selected.length <= 0 ? (
              ...
              selected.map((data, id) => (
                <MSelected candidate={data} key={id} />
              ))
            )
          ) : def && !changebtn ? (
            nrml.length <= 0 ? (
              ...
              nrml.map((data, id) => <MCandidate candidate={data} key={id} />)
            )
            ...
            shortlisted.length <= 0 ? (
              ...
              shortlisted.map((data, id) => (
                <MShortlist candidate={data} key={id} />
              ))
            )
          ) : rejected.length <= 0 ? (
            <div className="flex mt4 justify-center items-center">
            ...
            rejected.map((data, id) => <MRejected candidate={data} key={id} />)
          )}
        </div>
      </div>
    </div>
