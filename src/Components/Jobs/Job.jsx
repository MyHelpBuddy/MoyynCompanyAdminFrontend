          ...
          <div className="flex justify-center flex-row-l flex-row-m flex-column justify-center items-center">
            <button
              onClick={() => {
                ...
                setcandidatedata(job.candidatedata);
              }}
